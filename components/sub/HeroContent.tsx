    ...
    <motion.div initial="hidden" animate="visible" className='flex flex-row items-center justify-center px-20 mt-40 w-full z-[20]'>
        <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
                ...
                className='Welcome-box py-[8px] px-[7px] border border-[#7042f88b] opacity-[0.9]'>
                  ...
                  <h1 className='Welcome-text text-[13px]'>FullStack Mariwan Developer</h1>
                </motion.div>
                ...
                <motion.p variants={slideInFromLeft(0.8)} className='text-lg text-gray-400 my-5 max-w-[600px]'>
                  &apos;m a Full stack Software Engineer with Expereience in Website,
                  Mobile, and Software development. Checked out my projects and skills.
                </motion.p>
            ...
            <motion.div variants={slideInFromRight(0.8)}
             ...
             >
              <img src="/mainIconsdark.svg" alt="work icons" height={650} width={650}></img>
